...
<div class="tabsAction">
	[onshow;block=begin;when [user.rights.warehousepath.write;noerr]=1]
	
		[onshow;block=begin;when [object.status]=[Twarehousepath.STATUS_DRAFT]]
		...
		[onshow;block=begin;when [object.status]=[Twarehousepath.STATUS_VALIDATED]]
		...
		<!-- '-+' est l'équivalent d'un signe '<' (TBS oblige) -->
		[onshow;block=begin;when [object.status]-+[Twarehousepath.STATUS_REFUSED]]
