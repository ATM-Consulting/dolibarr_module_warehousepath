...
/**
 * 	\file		core/triggers/interface_99_modMyodule_warehousepathtrigger.class.php
 * 	\ingroup	warehousepath
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modWarehousepath_Mytrigger.class.php
 ...
 * Trigger class
 */
class Interfacewarehousepathtrigger
{
