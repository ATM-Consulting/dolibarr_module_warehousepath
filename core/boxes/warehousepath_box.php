 ...
 */
class warehousepathbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "warehousepath@warehousepath";
    public $boxlabel;
    public $depends = array("warehousepath");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/warehousepath/class/warehousepath.class.php";
