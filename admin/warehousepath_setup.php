...
require_once '../lib/warehousepath.lib.php';
...
$head = warehousepathAdminPrepareHead();
dol_fiche_head(
    $head,
    'settings',
    $langs->trans("Module104062Name"),
    0,
